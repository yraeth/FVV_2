...
\newcommand{\internfrontpageDE}{%
  ...
  DOKTOR\ifne{\myfirstauthorfemale}{IN} DER WISSENSCHAFTEN der ETH Z\"urich
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Figure definitions
\newcommand{\figurerule}{\hrule}	% rules above and below figures
%\newcommand{\tablerule}{\hrule}	% rules above and below tables
...
\newcommand{\createtitlepage}{
  \begin{titlepage}
    \begin{center}
      ...
      \iflanguage{english}{born on\ }{\iflanguage{german}{geboren am\ }{\langerrmessage}}\myfirstauthorbirthday
